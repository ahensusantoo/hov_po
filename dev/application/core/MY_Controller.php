...
class MY_Controller extends CI_Controller{
    ...
    {
        parent::__construct();
        $this->load->helper(array('url','fungsi','file','security','all'));
    ...
    public function handle_database_error() {
        $this->load->view('errors/html/error_db'); // Ganti dengan nama view yang sesuai
        exit;
    }
